...
export const STRATEGY_FRAMEWORKS: UPGFramework[] = [
  ...
  },
  {
    ...
    version: '1.0.0',
    description: 'Analyse seven interrelated elements — Strategy, Structure, Systems, Shared Values, Skills, Style, and Staff — to ensure organisational alignment.',
    category: 'strategy',
    origin: {
      type: 'practitioner',
    ...
    education: {
      purpose: 'Diagnose organisational alignment across seven interdependent elements — Strategy, Structure, Systems, Shared Values, Skills, Style, Staff — to find the root cause of execution failures.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Translate strategy into measurable objectives across four perspectives — Financial, Customer, Internal Process, Learning & Growth — so execution stays aligned with vision.',
  ...
  },
  {
    ...
    version: '1.0.0',
    description: 'Scan the macro-environment across six dimensions — Political, Economic, Social, Technological, Environmental, and Legal — to identify external forces shaping strategy.',
    category: 'strategy',
    origin: {
      type: 'practitioner',
    ...
    education: {
      purpose: 'Scan the macro-environment across six dimensions — Political, Economic, Social, Technological, Environmental, Legal — to spot forces that will reshape the competitive landscape.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Define strategy across five facets — Arenas, Vehicles, Differentiators, Staging, Economic Logic — ensuring the strategy is internally consistent and complete.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Identify the organisation\'s core competencies — capabilities that are rare, hard to imitate, and valuable across markets — to guide diversification and investment decisions.',
