...
export const ENGINEERING_FRAMEWORKS: UPGFramework[] = [
  {
    ...
    education: {
      purpose: 'Record architectural decisions as lightweight, immutable documents — Context, Decision, Consequences — so future teams understand why the system is the way it is.',
    ...
    presentation: {
      layout: {
        ...
        columns: [
          ...
          {
            property: 'build_artifact',
            label: 'Fitness Function',
            sortable: true
          },
          {
            property: 'ci_pipeline',
            label: 'Threshold',
            sortable: true
          },
          {
            property: 'code_repository',
            label: 'Frequency',
            sortable: true
          },
          {
