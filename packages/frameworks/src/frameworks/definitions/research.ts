...
export const RESEARCH_FRAMEWORKS: UPGFramework[] = [
  {
    ...
    education: {
      purpose: 'Synthesise research observations into what a user says, thinks, does, and feels — building a shared mental model of the user that goes beyond demographics.',
      core_question: 'What does this user truly think and feel versus what they say and do — and what do the gaps reveal?',
      when_to_use: [
  ...
  },
  {
    ...
    education: {
      ...
      core_question: 'What themes and patterns emerge when we group our raw research observations — and what surprised us?',
      when_to_use: [
        'You need to synthesise findings from multiple research activities',
        'Research insights are scattered and not accessible to the team',
        'You want to build a shared understanding of what you have learned'
  ...
  },
  {
    ...
    education: {
      purpose: 'Define the research objective, methodology, participants, timeline, and analysis plan before starting — ensuring research answers the right questions at the right fidelity.',
