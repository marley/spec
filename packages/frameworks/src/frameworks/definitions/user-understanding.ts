...
export const USER_UNDERSTANDING_FRAMEWORKS: UPGFramework[] = [
  ...
  },
  {
    ...
    education: {
      purpose: 'Map the complete customer lifecycle — from first awareness through onboarding, engagement, renewal, and advocacy — identifying moments that make or break the relationship.',
