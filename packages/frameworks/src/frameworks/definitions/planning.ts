...
export const PLANNING_FRAMEWORKS: UPGFramework[] = [
  ...
  },
  {
    ...
    education: {
      purpose: 'Lay out planned work on a time axis so stakeholders see what\'s coming when — the classic communication tool for aligning expectations.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Organise work by time horizon without committing to dates — Now is in progress, Next is committed, Later is under consideration — giving flexibility without losing direction.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Evaluate a product opportunity before committing resources — problem, target customer, solution, metrics, risks — on a single canvas that forces clarity and brevity.',
