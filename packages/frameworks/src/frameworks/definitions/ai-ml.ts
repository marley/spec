...
export const AI_ML_FRAMEWORKS: UPGFramework[] = [
  ...
  },
  {
    ...
    presentation: {
      layout: {
        ...
        columns: [
          ...
          {
            property: 'model_comparison',
            label: 'Safety',
            sortable: true
          },
          {
            property: 'hallucination_report',
            label: 'Latency',
            sortable: true
          },
          {
    ...
    education: {
      purpose: 'Evaluate large language model outputs across quality dimensions — accuracy, relevance, safety, coherence, groundedness — using both automated metrics and human review.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Catalogue proven prompt structures — chain of thought, few-shot, system prompts, structured output — so teams build reliable LLM interactions instead of guessing.',
