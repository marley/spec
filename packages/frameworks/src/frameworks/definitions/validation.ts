...
export const VALIDATION_FRAMEWORKS: UPGFramework[] = [
  {
    ...
    education: {
      purpose: 'Track product hypotheses through their lifecycle — from assumption to experiment to validated/invalidated — making the team\'s learning visible and cumulative.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Track all running and completed experiments in one place — hypothesis, method, status, result, learnings — so the team builds a cumulative record of validated knowledge.',
  ...
  },
  {
    ...
    education: {
      ...
      core_question: 'Which of our assumptions carry the most risk and have the least evidence — where should we run experiments first?',
      when_to_use: [
        'You have hypotheses about user needs or solutions that need testing',
        'You want to reduce risk before committing engineering resources',
        'The team is debating assumptions that can be tested empirically'
  ...
  },
  {
    ...
    education: {
      purpose: 'Design experiments that test one assumption at a time — hypothesis, metric, method, criteria — ensuring each experiment produces a clear learn-or-pivot signal.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Identify and test the single riskiest assumption in a product idea before investing in a full MVP — the fastest path to validating or killing an idea.',
  ...
  },
  {
    ...
    origin: {
      ...
      description: 'Coined by Alberto Savoia (former Google engineering director), published in \"The Right It\" (2019). Pretotyping tests market demand before building anything — using fake doors, landing pages, and other low-effort validation techniques.',
    ...
    education: {
      purpose: 'Test whether anyone wants a product before building it — using fake doors, landing pages, concierge MVPs — to separate \"I would use that\" from \"I actually used that\".',
  ...
  },
  {
    ...
    education: {
      purpose: 'Manage the validation process as a board — customer hypothesis, problem hypothesis, solution hypothesis — tracking which are validated, invalidated, or still testing.',
  ...
  },
  {
    ...
    version: '1.0.0',
    description: 'A single-card format for designing experiments — capturing hypothesis, test method, metrics, and success criteria in one place.',
    category: 'validation',
    origin: {
      type: 'practitioner',
    ...
    education: {
      purpose: 'Document a single experiment on a structured card — hypothesis, method, success criteria, results, next action — creating a lightweight, shareable experiment record.',
