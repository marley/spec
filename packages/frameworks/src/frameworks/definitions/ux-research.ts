...
export const UX_RESEARCH_FRAMEWORKS: UPGFramework[] = [
  {
    ...
    education: {
      purpose: 'Design a usability test — tasks, participants, metrics, protocol — that produces actionable findings about whether users can accomplish their goals with the product.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Collect longitudinal data on user behaviour in context — over days or weeks — to understand how product usage fits into real life rather than a lab setting.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Structure Jobs to Be Done interviews around the timeline of a purchase decision — from first thought through to satisfaction — to uncover the forces that drive switching behaviour.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Operationalise user research — participant recruitment, tooling, data management, governance — so research can scale beyond a single researcher doing everything manually.',
      core_question: 'Can our research function scale — is participant recruitment, consent management, and insight distribution systematised or bottlenecked?',
      when_to_use: [
        'You need to understand user behaviour, needs, or pain points',
        'Design decisions require empirical evidence rather than assumptions',
        'You want to evaluate usability of an existing product or prototype'
  ...
  },
  {
    ...
    education: {
      purpose: 'Design surveys that produce valid, actionable data — clear objectives, unbiased questions, appropriate scales, adequate sample size — avoiding the common traps that produce misleading results.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Observe and interview users in their actual work environment — watching what they do, asking why, and discovering tacit knowledge that lab-based research misses.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Combine quantitative and qualitative research methods strategically — using numbers to find what, and stories to understand why — for more robust and actionable findings.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Structure user interviews in five acts — friendly intro, context questions, deep-dive, retrospective, wrap-up — to build rapport, go deep, and close cleanly.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Enable non-researchers to conduct basic research safely — with templates, training, ethics guidelines, and quality checks — so research scales beyond the UXR team.',
