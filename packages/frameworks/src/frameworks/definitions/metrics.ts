...
export const METRICS_FRAMEWORKS: UPGFramework[] = [
  ...
  },
  {
    ...
    education: {
      purpose: 'Evaluate user experience quality across five dimensions — Happiness, Engagement, Adoption, Retention, Task success — giving product teams a balanced UX scorecard.',
