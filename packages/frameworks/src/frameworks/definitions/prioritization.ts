...
export const PRIORITIZATION_FRAMEWORKS: UPGFramework[] = [
  ...
  },
  {
      ...
      computed_properties: [
        {
          ...
          expression: '(delighter + performance) / (delighter + performance + must_be + indifferent)',
          entity_type: 'feature',
        ...
        },
        {
          ...
          expression: '(must_be + performance) / (delighter + performance + must_be + indifferent) * -1',
          entity_type: 'feature',
    ...
    education: {
      purpose: 'Classify features by how they affect user satisfaction — distinguishing must-haves from delighters — so teams invest in the right category at the right time.',
  ...
  },
  {
    ...
    education: {
      ...
      core_question: 'When we weight the criteria that matter to our strategy, which items score highest — and does the ranking match our intuition?',
      when_to_use: [
        'You have more ideas or features than capacity to build them',
        'Stakeholders disagree on what to build next',
        'You need a transparent, defensible prioritisation process'
