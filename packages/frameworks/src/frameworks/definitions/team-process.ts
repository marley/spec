...
export const TEAM_PROCESS_FRAMEWORKS: UPGFramework[] = [
  ...
  },
  {
    ...
    education: {
      purpose: 'Reflect on the last iteration as a team — what went well, what didn\'t, what to try next — creating a continuous improvement habit.',
  ...
  },
  {
    ...
    name: 'Team API',
    version: '1.0.0',
    description: 'A formal description of how a team interacts with the rest of the organisation — defining its mission, capabilities, communication channels, and ways of working — making team interfaces explicit.',
    category: 'team_process',
    origin: {
      type: 'practitioner',
    ...
    education: {
      purpose: 'Define a team\'s interface — what they own, how to interact with them, what they expect, what they provide — so other teams can collaborate without ambiguity.',
  ...
  },
  {
    ...
    version: '1.0.0',
    description: 'A decision-making framework assigning four roles — Driver, Approver, Contributors, and Informed — to every major decision, eliminating ambiguity about who decides and who is consulted.',
    category: 'team_process',
    origin: {
      type: 'practitioner',
      attribution: 'Intuit',
    ...
    education: {
      purpose: 'Assign clear decision-making roles — Driver, Approver, Contributors, Informed — so decisions are made efficiently with the right people involved at the right level.',
  ...
  },
  {
    ...
    version: '1.0.0',
    description: 'A team-authored set of explicit norms, expectations, and practices — covering communication, availability, code review, meeting etiquette, and conflict resolution — revisited regularly.',
    category: 'team_process',
    origin: {
      type: 'practitioner',
      year: 2006,
  ...
  // ── Reflection classics ────────────────────────────────────────────────────
  // Five canonical reflective methods that pair with the UPGApproach
  // catalog. They are the named techniques inside the Reflect approach.
  {
    id: 'five-whys',
