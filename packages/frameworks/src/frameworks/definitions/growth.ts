...
export const GROWTH_FRAMEWORKS: UPGFramework[] = [
  ...
  },
  {
    ...
    education: {
      purpose: 'Build a quantitative model of your growth engine — acquisition, activation, retention, revenue — to identify which lever moves the top-line number most.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Map the mechanics of how one user brings in more users — the viral coefficient and cycle time — to determine whether organic growth is self-sustaining.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Design habit-forming products through a four-phase loop — Trigger, Action, Variable Reward, Investment — that brings users back without relying on expensive re-engagement.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Decompose growth into four components — Engine (acquisition loops), Turbo Boosts (one-time campaigns), Lubricants (conversion optimisations), Fuel (capital/content) — to diagnose what\'s driving and limiting growth.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Design a product-led growth flywheel where product usage drives acquisition, activation drives retention, and retention drives expansion — each stage feeding the next.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Identify and optimise closed-loop systems where the output of one step becomes the input to an earlier step — creating compounding growth instead of linear acquisition.',
