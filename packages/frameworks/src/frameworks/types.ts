...
//
// Methodologies are modelled as `UPGWorkflow` records (from
// `@unified-product-graph/core`) whose steps all have `kind: 'framework'`.
// A single primitive covers both single-framework and bundled-methodology
// shapes.
