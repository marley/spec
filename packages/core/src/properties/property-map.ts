...
import type { HypothesisProperties, HypothesisEvidenceProperties, ExperimentProperties, ExperimentPlanProperties, ExperimentRunProperties, LearningProperties, TestPlanProperties, EvidenceProperties, ResearchPlanProperties } from './domains/validation.js'
...
import type { ContentPieceProperties, KnowledgeBaseArticleProperties, BrandAssetProperties, InternalDocProperties, PromptTemplateProperties, ContentCalendarProperties, ContentThemeProperties, DocumentationTemplateProperties, DocumentProperties } from './domains/content.js'
...
import type { TestSuiteProperties, TestCaseProperties, QaSessionProperties, RegressionTestProperties, TestCoverageReportProperties, TestEnvironmentProperties, TestResultProperties } from './domains/testing.js'
...
import type { AiModelProperties, PromptVersionProperties, EvalBenchmarkProperties, EvalRunProperties, AiCostTrackerProperties, HallucinationReportProperties, AiGuardrailProperties, ModelComparisonProperties, AiExperimentProperties, AiDatasetProperties, AiTraceProperties } from './domains/ai.js'
...
import type { WorkspaceProperties } from './domains/workspace.js'
...
export type { HypothesisProperties, HypothesisEvidenceProperties, ExperimentProperties, ExperimentPlanProperties, ExperimentRunProperties, LearningProperties, TestPlanProperties, EvidenceProperties, ResearchPlanProperties }
...
export type { ContentPieceProperties, KnowledgeBaseArticleProperties, BrandAssetProperties, InternalDocProperties, PromptTemplateProperties, ContentCalendarProperties, ContentThemeProperties, DocumentationTemplateProperties, DocumentProperties }
...
export type { TestSuiteProperties, TestCaseProperties, QaSessionProperties, RegressionTestProperties, TestCoverageReportProperties, TestEnvironmentProperties, TestResultProperties }
...
export type { AiModelProperties, PromptVersionProperties, EvalBenchmarkProperties, EvalRunProperties, AiCostTrackerProperties, HallucinationReportProperties, AiGuardrailProperties, ModelComparisonProperties, AiExperimentProperties, AiDatasetProperties, AiTraceProperties }
