 ...
 *
 * Generated: 2026-05-20T13:06:08.581Z
 * Entity types with properties: 316
 */
...
export const UPG_PROPERTY_SCHEMA: Record<string, PropertySchema> = {
  ...
  a11y_issue: {
    severity: { type: 'string', enum: ['minor', 'moderate', 'serious', 'critical'], description: 'Severity. Aligned to axe-core\'s 4-level impact scale (industry standard): \'minor\' < \'moderate\' < \'serious\' < \'critical\'. Migration: the previous 3-level scale (\'critical\' | \'major\' | \'minor\') maps to (\'critical\' | \'serious\' | \'minor\') respectively.' },
  ...
  affinity_cluster: {
    ...
    confidence: { type: 'string', enum: ['high', 'medium', 'low'], description: 'Confidence in the theme\'s validity' },
  },
  ...
  api_contract: {
    ...
    protocol: { type: 'string', enum: ['REST', 'GraphQL', 'gRPC', 'AsyncAPI', 'SOAP', 'WebSocket', 'MQTT', 'other'], description: 'Communication protocol' },
  ...
  assumption: {
    confidence: { type: 'string', enum: ['high', 'medium', 'low'], description: 'Confidence before testing. Independent of whether the assumption is validated (tracked in lifecycle).' },
    validation_method: { type: 'string', description: 'Validation method, planned or used' },
    risk_level: {
      type: 'object', description: 'Exposure if the assumption turns out wrong',
      properties: {
  ...
  bug: {
    bug_severity: { type: 'string', enum: ['critical', 'major', 'minor', 'trivial'], description: 'Impact severity. Independent of priority (which governs when it gets fixed). `critical` = data loss or complete feature failure. `trivial` = cosmetic only.' },
    bug_status: { type: 'string', enum: ['open', 'in_progress', 'fixed', 'verified', 'wont_fix'], description: '@deprecated since v0.4.0. Use top-level `UPGBaseNode.status`. Values map identically: open | in_progress | fixed | verified | wont_fix. Migration: `UPG_PROPERTY_MIGRATIONS[\'0.4.0\']` lifts this to `status`.' },
  ...
  ceremony: {
    ...
    cadence: { type: 'string', description: 'How often the ceremony occurs (e.g. "daily", "biweekly")' },
  ...
  churn_reason: {
    ...
    frequency_rating: { type: 'string', enum: ['rare', 'occasional', 'regular', 'constant', 'other'], description: 'Qualitative frequency tier when an exact count is not known' },
    contributing_factors: { type: 'string[]', description: 'Other factors that contributed to the churn' },
    signal_sentiment: { type: 'string', enum: ['positive', 'negative', 'neutral', 'mixed'], description: 'Detected sentiment of the churn signal' },
  ...
  content_calendar: {
    ...
    frequency_rating: { type: 'string', enum: ['rare', 'occasional', 'regular', 'constant', 'other'], description: 'Qualitative rate tier when an exact rate is unknown' },
  },
  ...
  contract_clause: {
    ...
    risk_level: {
      type: 'object', description: 'Risk level if the clause is accepted as-is (1 = negligible, 5 = severe exposure)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  customer_feedback: {
    ...
    signal_sentiment: { type: 'string', enum: ['positive', 'negative', 'neutral', 'mixed'], description: 'Detected sentiment of the underlying signal' },
  ...
  data_flow: {
    ...
    direction: { type: 'string', enum: ['unidirectional', 'bidirectional'], description: 'Direction' },
  ...
  data_product: {
    data_product_type: { type: 'string', description: 'Classification of the data product (e.g. "report", "dataset", "stream")' },
  ...
  data_source: {
    ...
    refresh_cadence: { type: 'string', description: 'How often the data is refreshed (e.g. "hourly", "daily")' },
  },
  ...
  deliverable: {
    deliverable_type: { type: 'string', description: 'Kind of deliverable (e.g. "document", "prototype", "release")' },
  ...
  design_question: {
    ...
    confidence: { type: 'string', enum: ['high', 'medium', 'low'], description: 'Confidence the question is well-framed. Distinct from confidence in any answer.' },
  ...
  desired_outcome: {
    ...
    importance: {
      type: 'object', description: 'How important this outcome is to the user (1 = low, 5 = critical)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    current_satisfaction: {
      type: 'object', description: 'How satisfied the user currently is with this outcome (1 = very unsatisfied, 5 = fully satisfied)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  evidence: {
    ...
    weight: {
      type: 'object', description: 'Strength (UPGAssessment, scale `weight_5pt`).',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  // ExperimentPlanProperties — Planning intent for a structured test of a hypothesis (UCS pattern P4: work-unit).
  experiment_plan: {
    ...
    projected_reach: {
      type: 'object', description: 'Projected reach: how many people the run is expected to touch (UPGAssessment)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    projected_impact: {
      type: 'object', description: 'Projected impact on the target metric (UPGAssessment)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    confidence: {
      type: 'object', description: 'Team confidence at plan-time (UPGAssessment, scale `confidence_5pt`)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    cost_estimate: {
      type: 'object', description: 'Cost estimate at plan-time (UPGAssessment)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  experiment_run: {
    ...
    severity_of_finding: {
      type: 'object', description: 'Severity / strength of the finding (UPGAssessment)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  feasibility_study: {
    ...
    confidence: { type: 'string', enum: ['high', 'medium', 'low'], description: 'Confidence in the conclusion' },
  },
  ...
  feature_request: {
    ...
    signal_sentiment: { type: 'string', enum: ['positive', 'negative', 'neutral', 'mixed'], description: 'Detected sentiment of the request' },
    ...
    revenue_impact: {
      type: 'object', description: 'Estimated revenue impact if implemented (1-5)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    effort_estimate: {
      type: 'object', description: 'Estimated implementation effort (1-5)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  feedback_theme: {
    ...
    frequency: {
      type: 'object', description: 'How often the theme is mentioned (1-5)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  fix: {
    ...
    deployed_at: { type: 'string', description: 'ISO timestamp landed in the target environment. Pairs with `fix_status === \'deployed\'`.' },
  ...
  forecast: {
    ...
    confidence: {
      type: 'object', description: 'Confidence in the prediction (1 = speculative, 5 = high conviction)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  hallucination_report: {
    ...
    severity: {
      type: 'object', description: 'Impact severity (1 = trivial, 5 = dangerous misinformation)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  hypothesis: {
    ...
    current_confidence: {
      type: 'object', description: 'Team confidence at the current point in time. Derived from the weighted sum of attached `hypothesis_evidence` rows (formula spec\'d separately). Authors may set explicitly; loaders may overwrite from derivation.',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  hypothesis_evidence: {
    ...
    weight: {
      type: 'object', description: 'Strength of the evidence (UPGAssessment, scale `weight_5pt`).',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  incident: {
    ...
    severity_level: { type: 'string', enum: ['sev1', 'sev2', 'sev3', 'sev4'], description: 'Severity. `sev1` = critical/system down. `sev2` = major impact. `sev3` = minor impact. `sev4` = minimal impact. @example "sev1" for complete service unavailability' },
    urgency: { type: 'string', enum: ['high', 'low'], description: 'Notification urgency. Independent of severity. `high` triggers phone calls. `low` sends a message.' },
  ...
  insight: {
    ...
    confidence: { type: 'string', enum: ['high', 'medium', 'low'], description: 'Confidence. Reflects the strength and diversity of supporting evidence.' },
  ...
  integration_pattern: {
    pattern_type: { type: 'string', enum: ['api', 'event', 'file', 'database', 'webhook'], description: 'Type' },
  ...
  investigation: {
    severity: {
      type: 'object', description: 'Believed severity of the underlying issue. Drives prioritisation across investigations. Canonicalised in v0.4.0: the ad-hoc `\'low\' | \'medium\' | \'high\' | \'critical\'` shape was replaced by `UPGAssessment` so every "severity" property reports on the same axis. Migration: `low → 2`, `medium → 3`, `high → 4`, `critical → 5`.',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    resolved_at: { type: 'string', description: 'ISO timestamp the investigation was concluded. Pairs with `investigation_status === \'resolved\' | \'abandoned\'`.' },
  ...
  job: {
    ...
    importance: {
      type: 'object', description: 'Importance to the user (1 = low, 5 = critical)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    current_satisfaction: {
      type: 'object', description: 'Current satisfaction with how this job gets done (1 = very unsatisfied, 5 = fully satisfied)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  journey_action: {
    ...
    pain_score: {
      type: 'object', description: 'Pain (1 = effortless, 5 = very painful). Drives opportunity discovery.',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    opportunity_score: {
      type: 'object', description: 'Opportunity (1 = low leverage, 5 = high leverage). Pairs with `pain_score` to rank investment.',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  journey_step: {
    ...
    emotion_score: {
      type: 'object', description: 'User emotion (1 = very negative, 5 = very positive)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    friction_score: {
      type: 'object', description: 'Friction (1 = effortless, 5 = very painful)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  key_activity: {
    ...
    frequency_period: { type: 'string', description: 'Recurrence period (ISO-8601 `Duration`, e.g. `\'P7D\'`)' },
    frequency_rating: { type: 'string', enum: ['rare', 'occasional', 'regular', 'constant', 'other'], description: 'Qualitative tier. Use when an exact rate is unknown.' },
  ...
  key_resource: {
    ...
    scarcity_risk: {
      type: 'object', description: 'Replacement difficulty',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  key_result: {
    ...
    kr_status: { type: 'string', enum: ['on_track', 'at_risk', 'behind', 'achieved'], description: 'Delivery health' },
  },
  ...
  market_trend: {
    relevance: {
      type: 'object', description: 'Relevance to our product (1 = low, 5 = critical).',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    impact: {
      type: 'object', description: 'Expected impact on our market or category.',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  need: {
    ...
    frequency: {
      type: 'object', description: 'How often the user encounters this need (1 = rarely, 5 = constantly)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    severity: {
      type: 'object', description: 'How painful or disruptive the need is when unaddressed (1 = minor, 5 = critical)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    importance: {
      type: 'object', description: 'How important resolving this need is to the user (1 = low, 5 = critical)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  objection: {
    ...
    severity: {
      type: 'object', description: 'How frequently or strongly this objection comes up (1-5)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  observation: {
    ...
    sentiment: { type: 'string', enum: ['positive', 'negative', 'neutral', 'mixed'], description: 'Structured sentiment. Tools like Dovetail and EnjoyHQ converge on these four values. More precise than `highlight_tag` for aggregation.' },
  },
  ...
  opportunity: {
    reach: {
      type: 'object', description: 'How many users experience this problem',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    frequency: {
      type: 'object', description: 'How often users experience this problem',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    pain: {
      type: 'object', description: 'How painful it is when unaddressed',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  outcome: {
    ...
    confidence: {
      type: 'object', description: 'Confidence this is the right outcome to pursue',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    outcome_status: { type: 'string', description: 'Current lifecycle phase. Free-form until an outcome lifecycle is defined in `grammar/lifecycles.ts`.' },
  },
  ...
  partnership: {
    ...
    risk_level: {
      type: 'object', description: 'Exposure if the partnership fails (concentration risk, IP risk, etc.)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  pipeline_sales: {
    pipeline_type: { type: 'string', description: 'Classification of the pipeline (e.g. "new business", "expansion")' },
  ...
  rebuttal: {
    ...
    strength: {
      type: 'object', description: 'How convincing this rebuttal is (1-5)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  risk: {
    ...
    probability: {
      type: 'object', description: 'How likely this risk is to materialise (1 = unlikely, 5 = near certain)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    impact: {
      type: 'object', description: 'Severity of consequences if the risk materialises (1 = negligible, 5 = catastrophic)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  roadmap_item: {
    ...
    confidence: { type: 'string', enum: ['high', 'medium', 'low'], description: 'Delivery confidence within the planned period.' },
  ...
  root_cause: {
    severity: {
      type: 'object', description: 'Severity (1 = minor, 5 = critical)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  security_control: {
    ...
    effectiveness: {
      type: 'object', description: 'Mitigation effectiveness (1 = minimal, 5 = fully effective)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  security_policy: {
    ...
    review_cadence: { type: 'string', description: 'Review cadence (e.g. "annually", "quarterly")' },
    version: { type: 'string', description: 'Version' },
  ...
  service: {
    service_type: { type: 'string', enum: ['web', 'api', 'worker', 'db', 'queue', 'library', 'mobile', 'docs', 'lambda'], description: 'Functional classification. Expanded from Backstage\'s component type vocabulary.' },
  ...
  skill: {
    skill_category: { type: 'string', description: 'Category of the skill (e.g. "technical", "leadership", "design")' },
    ...
    rarity: {
      type: 'object', description: 'How scarce this skill is in the labour market this team hires from',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  solution: {
    ...
    reach: {
      type: 'object', description: 'How many users this solution reaches (1 = few, 5 = most)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    impact: {
      type: 'object', description: 'Expected impact on the target outcome (1 = minimal, 5 = transformative)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    confidence: {
      type: 'object', description: 'How confident the team is in this solution (1 = speculative, 5 = proven)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    effort: {
      type: 'object', description: 'Level of effort required to implement (1 = trivial, 5 = very large)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    rice_score: { type: 'number', description: 'Computed: (reach × impact × confidence) / effort' },
  },
  ...
  stakeholder: {
    ...
    influence: {
      type: 'object', description: 'How much influence this stakeholder has over decisions (1 = minimal, 5 = decisive)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    interest: {
      type: 'object', description: 'How much interest this stakeholder has in the outcome (1 = passive, 5 = deeply invested)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  support_ticket: {
    ...
    severity: {
      type: 'object', description: 'Impact severity of the issue (1 = cosmetic, 5 = service down)',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    signal_sentiment: { type: 'string', enum: ['positive', 'negative', 'neutral', 'mixed'], description: 'Detected sentiment of the customer\'s message' },
    signal_channel: { type: 'string', description: 'Channel through which the signal was received' },
  ...
  symptom: {
    ...
    severity: {
      type: 'object', description: 'Severity for affected users. Independent of how widespread the symptom is. Canonicalised in v0.4.0: the ad-hoc `\'low\' | \'medium\' | \'high\' | \'critical\'` shape was replaced by `UPGAssessment`.',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    frequency_rating: { type: 'string', enum: ['rare', 'occasional', 'regular', 'constant', 'other'], description: 'Qualitative frequency tier. Canonical replacement for the legacy `\'once\' | \'sporadic\' | \'frequent\' | \'constant\' | string` shape. Use when an exact rate is unknown. Migration: `once → rare`, `sporadic → occasional`, `frequent → regular`, `constant → constant`.' },
  ...
  technical_debt_item: {
    ...
    severity: {
      type: 'object', description: 'Severity on system or team. Requires human evaluation.',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    effort_to_fix: {
      type: 'object', description: 'Estimated effort to resolve. Requires team knowledge of the codebase.',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  // TestPlanProperties — TestPlan entity.
  test_plan: {
    plan_type: { type: 'string', enum: ['usability', 'concept', 'ab_test', 'beta', 'smoke'], description: 'Test type' },
    sample_size: { type: 'number', description: 'Participants or observations' },
    duration: { type: 'string', description: 'Run duration. @example "2 weeks"' },
    success_criteria: { type: 'string', description: 'Criteria determining whether the test passes' },
  },
  ...
  threat: {
    ...
    likelihood: {
      type: 'object', description: 'Likelihood (1 = theoretical, 5 = actively exploited). @example value 5 for a known, exploitable, commonly targeted pattern',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
    ...
    impact: {
      type: 'object', description: 'Impact (1 = minimal, 5 = catastrophic). @example value 5 for threats that expose PII or cause complete service compromise',
      properties: {
        value: { type: 'number', description: 'The numeric value — used for computation' },
        label: { type: 'string', description: 'The qualitative label — what the assessor meant' },
        scale_id: { type: 'string', description: 'Which assessment scale this was rated on (optional)' },
  ...
  touchpoint: {
    touchpoint_channel: { type: 'string', description: 'Channel where the interaction occurs (e.g. "email", "in-app", "call")' },
  ...
  user_advisory_board: {
    ...
    meeting_cadence: { type: 'string', description: 'How often the board meets (e.g. "monthly", "quarterly")' },
  ...
  vulnerability: {
    ...
    severity: { type: 'string', enum: ['critical', 'high', 'medium', 'low', 'informational'], description: 'Categorical severity derived from CVSS. `critical` = 9.0–10.0. `high` = 7.0–8.9. `medium` = 4.0–6.9. `low` = 0.1–3.9. `informational` = 0.0. Score alone is insufficient for triage; severity drives filtering and prioritisation. @example "critical" for a remotely exploitable, no-auth-required vulnerability' },
