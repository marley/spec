...
export const PORTFOLIO_FRAMEWORKS: UPGFramework[] = [
  {
    ...
    version: '1.0.0',
    description: 'The classic portfolio analysis tool plotting business units on market growth rate vs. relative market share. Classifies them as Stars, Cash Cows, Question Marks, or Dogs to guide investment decisions.',
    category: 'portfolio',
    origin: {
      type: 'practitioner',
  ...
  },
  {
    ...
    version: '1.0.0',
    description: 'A nine-cell portfolio analysis matrix plotting business units on industry attractiveness vs. competitive strength. More nuanced than BCG; uses weighted multi-factor scores for each axis.',
    category: 'portfolio',
    origin: {
      type: 'practitioner',
  ...
  },
  {
    ...
    version: '1.0.0',
    description: 'The four-stage lifecycle (Introduction, Growth, Maturity, Decline) describing revenue and profit patterns over a product\'s life. Informs marketing, pricing, and investment strategy at each stage.',
    category: 'portfolio',
    origin: {
      type: 'practitioner',
