...
export const MARKETING_FRAMEWORKS: UPGFramework[] = [
  ...
  },
  {
    ...
    education: {
      purpose: 'Segment the market, select target segments, and position the product for each. Marketing effort concentrates where it has the highest chance of resonance.',
