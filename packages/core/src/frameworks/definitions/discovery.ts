...
export const DISCOVERY_FRAMEWORKS: UPGFramework[] = [
  ...
  },
  {
    ...
    education: {
      purpose: 'Run discovery and delivery in parallel. One track validates what to build next; the other ships validated work. The team always has validated ideas in flight.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Capture every assumption behind a product idea (desirability, viability, feasibility) and rank them by risk. The team knows exactly what to test first.',
      core_question: 'What are we assuming about our customers, market, and technology? Which assumptions would kill the idea if wrong?',
      when_to_use: [
        'You need to understand unmet user needs before committing to solutions',
        'The problem space is ambiguous and requires structured exploration',
        'You want to reduce the risk of building the wrong thing'
