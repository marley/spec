 ...
 *
 * Dedup: removed `customer-effort-score-cs` (duplicate
 * of `customer-effort-score` in feedback-voc) and `voice-of-customer`
 * (duplicate of `voice-of-customer-program` in feedback-voc). VoC and CES
 * are feedback metrics; feedback_voc is the canonical home.
 */
...
export const CUSTOMER_SUCCESS_FRAMEWORKS: UPGFramework[] = [
  {
    ...
    version: '1.0.0',
    description: 'A cross-functional map showing the customer journey alongside frontstage actions, backstage processes, and support systems. Reveals how service delivery actually works end to end.',
    ...
    education: {
      ...
      core_question: 'Where in our service delivery chain do things break down? Are the failures visible to the customer or hidden backstage?',
      when_to_use: [
