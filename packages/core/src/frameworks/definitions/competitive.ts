...
export const COMPETITIVE_FRAMEWORKS: UPGFramework[] = [
  ...
  },
  {
    ...
    education: {
      purpose: 'Interview won and lost prospects to discover the real decision drivers (what buyers actually thought, not what CRM says). Feed insights back into product and sales.',
  ...
  },
  {
    ...
    education: {
      ...
      core_question: 'How do customers perceive our position relative to competitors? Does their perception match our intended positioning?',
      when_to_use: [
        'You are entering a crowded market and need to find differentiation',
        'A new competitor has emerged and you need to assess the threat',
        'You want to identify gaps in competitor offerings you can exploit'
  ...
  },
  {
    ...
    version: '1.0.0',
    description: 'Build a comprehensive dossier on a competitor. Covers strategy, product, team, funding, customers, strengths, and weaknesses.',
    category: 'competitive',
    origin: {
      type: 'practitioner',
    ...
    education: {
      purpose: 'Build a comprehensive profile of a competitor: strategy, strengths, weaknesses, likely moves, customer perception. A living intelligence document.',
  ...
  },
  {
    ...
    version: '1.0.0',
    description: 'Map adoption stages from Innovators through Early Adopters, Early Majority, Late Majority, and Laggards. The chasm between early adopters and the mainstream is the critical crossing.',
    category: 'competitive',
    origin: {
      type: 'practitioner',
