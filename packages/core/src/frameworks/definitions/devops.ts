...
export const DEVOPS_FRAMEWORKS: UPGFramework[] = [
  ...
  },
  {
    ...
    education: {
      purpose: 'Implement the three pillars of observability (logs, metrics, traces) in a coordinated way. Teams understand system behaviour from any entry point.',
  ...
  },
  {
    ...
    version: '1.0.0',
    description: 'A learning-focused incident review that examines what happened, why, and how to prevent recurrence. Focus on systems, not individuals.',
    category: 'devops',
    origin: {
      type: 'practitioner',
