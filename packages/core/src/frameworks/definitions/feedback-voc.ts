...
export const FEEDBACK_VOC_FRAMEWORKS: UPGFramework[] = [
  {
    ...
    version: '1.0.0',
    description: 'Structured VoC program: capture, aggregate, and act on customer feedback across channels.',
  ...
  },
  {
    ...
    education: {
      purpose: 'Let customers vote on feature requests to surface demand signal. Votes measure enthusiasm; willingness to pay and strategic fit need other inputs.',
