...
const lines: string[] = [
  ...
  '  description?: string',
  '  enum?: string[]',
  '  /** For object-typed fields — nested property shapes. */',
  '  properties?: Record<string, PropertyDefinition>',
  '  /** For object-typed fields — required keys within `properties`. */',
  '  required?: string[]',
  '}',
  '',
...
console.log(`Generated property registry: ${allInterfaces.length} entity types`)
